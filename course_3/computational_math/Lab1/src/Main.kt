...
fun main(args: Array<String>) {
    ...
    println("Машинная бесконечность для вещественного числа стандартной точности: " + getMachineInfinity(0.1F, 0.1F))
    println("Машинная бесконечность для вещественного числа повышенной точности: " + getMachineInfinity(0.1, 0.1))

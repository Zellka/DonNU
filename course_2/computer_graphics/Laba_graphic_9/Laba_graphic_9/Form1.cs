/*
4. Напишите программу для вычерчивания набора из 30 треугольников. 
Вершины первого треугольника заданы в точках (1, 1), (6, 1), (3, 5).
Каждый следующий треугольник получается путем поворота
предыдущего на угол 3 вокруг точки (3, 3). */

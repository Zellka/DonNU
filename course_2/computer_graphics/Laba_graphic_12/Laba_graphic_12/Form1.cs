...
namespace Laba_graphic_12
{
    public partial class Form1 : Form
    {
        int n = 20;
        Graphics dc; Pen p;
        double[] x = { 0.75, 0.5, 0.75, 1.5, 2.25, 2.5, 3, 5, 6.25, 6.5, 6.5, 6.5, 6.25, 5, 3, 2.5, 2.25, 1.5, 0.75, 0.5, 0.75 };
        double[] y = { 1.4, 1, 0.6, 0.4, 0.7, 0.9, 0.85, 0.75, 0.8, 0.85, 1, 1.15, 1.2, 1.25, 1.15, 1.1, 1.3, 1.6, 1.4, 1, 0.6 };
        ...
        //функция вычерчивания линии (область вывода 10х7)

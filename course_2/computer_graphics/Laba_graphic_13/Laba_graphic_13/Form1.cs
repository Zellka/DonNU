...
namespace Laba_graphic_13
{
    public partial class Form1 : Form
    {
        ...
        private bool CounterClock(int h, int i, int j, ref double pdist)
        {
        ...
        private void PolyTria()
        {
            ...
            while (m > 3)
            {
                ...
                for (i = 0; i < m; i++)
                {
                    ...
                    if (CounterClock(h, i, j, ref diag) && (diag < min_diag))
